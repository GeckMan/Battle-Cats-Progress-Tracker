...
import FriendMedalsClient from "./FriendMedalsClient";

export default async function FriendMedalsPage(props: {
  ...
  if (!friendship) {
    return (
      <div className="p-4 pt-16 md:p-8 space-y-4">
        ...
        <div className="text-sm text-gray-400">You must be friends to view their medals.</div>
      </div>
    );
  }
